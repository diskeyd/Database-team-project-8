...
--    별 릴레이션으로 분리하여 마스터 데이터화 (1NF 강화 + 기준 관계 FK 정합).
-- ─────────────────────────────────────────────────────────────────────────────
CREATE TABLE `카테고리` (
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 4. 사원
--    조직 소속 구성원. 자기참조 FK(상사ID)로 사원 내부 관리 위계 표현
--    (상사 1 : 부하 N).
-- ─────────────────────────────────────────────────────────────────────────────
CREATE TABLE `사원` (
...
--    surrogate PK(계좌ID) 채택. 조직명 FK로 식별 관계 의미 보존.
-- ─────────────────────────────────────────────────────────────────────────────
CREATE TABLE `계좌` (
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 7. 예산
--    조직별·카테고리별 예산. 기준 관계(카테고리 1 : 예산 N) 흡수 — 카테고리ID FK.
-- ─────────────────────────────────────────────────────────────────────────────
CREATE TABLE `예산` (
